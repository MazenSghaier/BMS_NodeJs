...
@InputType()
class DeliveryVoucherCreateInput {
  @ApiProperty({
    required: false,
  })
  @IsDate()
  ...
  @ApiProperty({
    required: false,
    type: () => InvoiceCreateNestedManyWithoutDeliveryVouchersInput,
  })
  @ValidateNested()
  @Type(() => InvoiceCreateNestedManyWithoutDeliveryVouchersInput)
  @IsOptional()
  @Field(() => InvoiceCreateNestedManyWithoutDeliveryVouchersInput, {
    nullable: true,
  })
...
export { DeliveryVoucherCreateInput as DeliveryVoucherCreateInput };
