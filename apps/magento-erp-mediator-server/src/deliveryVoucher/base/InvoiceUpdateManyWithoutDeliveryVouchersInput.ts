...
@InputType()
class InvoiceUpdateManyWithoutDeliveryVouchersInput {
...
export { InvoiceUpdateManyWithoutDeliveryVouchersInput as InvoiceUpdateManyWithoutDeliveryVouchersInput };
