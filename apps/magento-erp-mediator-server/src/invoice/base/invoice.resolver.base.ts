...
export class InvoiceResolverBase {
  ...
  async createInvoice(
    ...
    return await this.service.createInvoice({
      ...
      data: {
        ...
        deliveryVoucher: args.data.deliveryVoucher
          ? {
              connect: args.data.deliveryVoucher,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => DeliveryVoucher, {
    nullable: true,
    name: "deliveryVoucher",
  })
  async getDeliveryVoucher(
    @graphql.Parent() parent: Invoice
  ): Promise<DeliveryVoucher | null> {
    const result = await this.service.getDeliveryVoucher(parent.id);
